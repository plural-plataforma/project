...
export const listIconBoxClasses = {
  ...
  amber:
    "bg-amber-100 text-amber-700 ring-1 ring-brand-purple/25 dark:bg-amber-900/40 dark:text-amber-400",
} as const;

export function listCardClass(
  highlight: keyof typeof listCardHighlightClasses = "default",
) {
  return cn(
...
export function listIconBoxClass(
  highlight: keyof typeof listIconBoxClasses = "default",
) {
  return cn(
...
export const listFilterCardClass =
  "mb-4 shadow-card border-t-2 border-t-brand-purple/35";
