...
namespace api.Migrations
{
    ...
    [Migration("20260924202339_HabilidadeIdProfessor")]
    partial class HabilidadeIdProfessor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.Models.AceiteTermo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("TermoVersaoId")
                        .HasColumnType("integer")
                        .HasColumnName("termoversaoid");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_aceites_termos");

                    b.HasIndex("TermoVersaoId")
                        .HasDatabaseName("ix_aceites_termos_termoversaoid");

                    b.HasIndex("UsuarioId", "TermoVersaoId")
                        .IsUnique()
                        .HasDatabaseName("ix_aceites_termos_usuarioid_termoversaoid");

                    b.ToTable("aceites_termos");
                });
            ...
            modelBuilder.Entity("api.Models.Aluno", b =>
                {
                    ...
                    b.Property<string>("PerfilPedagogico")
                        .HasColumnType("text")
                        .HasColumnName("perfilpedagogico");
            ...
            modelBuilder.Entity("api.Models.Artigo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("TempoLeituraMinutos")
                        .HasColumnType("integer")
                        .HasColumnName("tempoleituraminutos");
            ...
            modelBuilder.Entity("api.Models.ConfiguracaoSite", b =>
                {
                    ...
                    b.HasKey("Chave")
                        .HasName("pk_configuracoes_site");

                    b.ToTable("configuracoes_site");
                });
            ...
            modelBuilder.Entity("api.Models.DiagnosticoFinal", b =>
                {
                    ...
                    b.Property<string>("HabilidadesAReenforcar")
                        .HasColumnType("text")
                        .HasColumnName("habilidadesareenforcar");

                    b.Property<string>("HabilidadesFortes")
                        .HasColumnType("text")
                        .HasColumnName("habilidadesfortes");
            ...
            modelBuilder.Entity("api.Models.GeracaoIALog", b =>
                {
                    ...
                    b.Property<bool>("BloqueadoPorLimite")
                        .HasColumnType("boolean")
                        .HasColumnName("bloqueadoporlimite");
                    ...
                    b.HasIndex("ProfessorId", "CriadoEm")
            ...
            modelBuilder.Entity("api.Models.Habilidade", b =>
                {
                    ...
                    b.HasIndex("IdProfessor")
                        .HasDatabaseName("ix_habilidades_idprofessor");
            ...
            modelBuilder.Entity("api.Models.Notificacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("ProfessorId", "CreatedAt")
            ...
            modelBuilder.Entity("api.Models.PaeeObjetivoCatalogo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("TextoModelo")
                        .HasColumnType("text")
                        .HasColumnName("textomodelo");

                    b.HasKey("Id")
                        .HasName("pk_paee_objetivos_catalogo");

                    b.HasIndex("Codigo")
                        .IsUnique();

                    b.ToTable("paee_objetivos_catalogo");
                });
            ...
            modelBuilder.Entity("api.Models.Planejamento", b =>
                {
                    ...
                    b.Property<int?>("ObjetivoCurtoCatalogoId")
                        .HasColumnType("integer")
                        .HasColumnName("objetivocurtocatalogoid");

                    b.Property<string>("ObjetivoCurtoPrazo")
                        .HasColumnType("text")
                        .HasColumnName("objetivocurtoprazo");

                    b.Property<int?>("ObjetivoLongoCatalogoId")
                        .HasColumnType("integer")
                        .HasColumnName("objetivolongocatalogoid");

                    b.Property<string>("ObjetivoLongoPrazo")
                        .HasColumnType("text")
                        .HasColumnName("objetivolongoprazo");

                    b.Property<int?>("ObjetivoMedioCatalogoId")
                        .HasColumnType("integer")
                        .HasColumnName("objetivomediocatalogoid");
                    ...
                    b.HasIndex("ObjetivoCurtoCatalogoId")
                        .HasDatabaseName("ix_planejamentos_objetivocurtocatalogoid");

                    b.HasIndex("ObjetivoLongoCatalogoId")
                        .HasDatabaseName("ix_planejamentos_objetivolongocatalogoid");

                    b.HasIndex("ObjetivoMedioCatalogoId")
                        .HasDatabaseName("ix_planejamentos_objetivomediocatalogoid");
            ...
            modelBuilder.Entity("api.Models.Relatorio", b =>
                {
                    ...
                    b.Property<int?>("FormatoFinal")
                        .HasColumnType("integer")
                        .HasColumnName("formatofinal");
                    ...
                    b.Property<string>("TextoFinal")
                        .HasColumnType("text")
                        .HasColumnName("textofinal");

                    b.Property<DateTime?>("TextoFinalGeradoEm")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("textofinalgeradoem");
            ...
            modelBuilder.Entity("api.Models.RelatorioSecao", b =>
                {
                    ...
                    b.Property<string>("TextoRevisado")
                        .HasColumnType("text")
                        .HasColumnName("textorevisado");
            ...
            modelBuilder.Entity("api.Models.Termo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("api.Models.TermoVersao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_termos_versoes");

                    b.HasIndex("TermoId", "Versao")
                        .IsUnique()
                        .HasDatabaseName("ix_termos_versoes_termoid_versao");

                    b.ToTable("termos_versoes");
                });
            ...
            modelBuilder.Entity("api.Models.Usuario", b =>
                {
                    ...
                    b.Property<string>("HotmartSubscriberCode")
                        .HasColumnType("text")
                        .HasColumnName("hotmartsubscribercode");
            ...
            modelBuilder.Entity("api.Models.AceiteTermo", b =>
                {
                    b.HasOne("api.Models.TermoVersao", "TermoVersao")
                        .WithMany()
                        .HasForeignKey("TermoVersaoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_aceites_termos_termos_versoes_termoversaoid");
                    ...
                    b.HasOne("api.Models.Usuario", "Usuario")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_aceites_termos_aspnetusers_usuarioid");

                    b.Navigation("TermoVersao");
            ...
            modelBuilder.Entity("api.Models.Habilidade", b =>
                {
                    b.HasOne("api.Models.Professor", "Professor")
                        ...
                        .HasForeignKey("IdProfessor")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("fk_habilidades_professores_idprofessor");
            ...
            modelBuilder.Entity("api.Models.Planejamento", b =>
                {
                    ...
                    b.HasOne("api.Models.PaeeObjetivoCatalogo", "ObjetivoCurtoCatalogo")
                        .WithMany()
                        .HasForeignKey("ObjetivoCurtoCatalogoId")
                        .HasConstraintName("fk_planejamentos_paee_objetivos_catalogo_objetivocurtocatalogo~");

                    b.HasOne("api.Models.PaeeObjetivoCatalogo", "ObjetivoLongoCatalogo")
                        .WithMany()
                        .HasForeignKey("ObjetivoLongoCatalogoId")
                        .HasConstraintName("fk_planejamentos_paee_objetivos_catalogo_objetivolongocatalogo~");

                    b.HasOne("api.Models.PaeeObjetivoCatalogo", "ObjetivoMedioCatalogo")
                        .WithMany()
                        .HasForeignKey("ObjetivoMedioCatalogoId")
                        .HasConstraintName("fk_planejamentos_paee_objetivos_catalogo_objetivomediocatalogo~");

                    b.Navigation("ObjetivoCurtoCatalogo");

                    b.Navigation("ObjetivoLongoCatalogo");

                    b.Navigation("ObjetivoMedioCatalogo");
            ...
            modelBuilder.Entity("api.Models.TermoVersao", b =>
                {
                    b.HasOne("api.Models.Termo", "Termo")
                        .WithMany("Versoes")
                        .HasForeignKey("TermoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_termos_versoes_termos_termoid");
